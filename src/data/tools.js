import {
    ...
    TrendingUp, Cake, Code, Timer, Brain, Image as ImageIcon, Youtube, FileText, Scroll, Star, Wand2
} from 'lucide-react';
...
export const tools = [
    ...
    { id: 'tarot', title: '타로 카드', icon: Sparkles, path: '/tarot', color: 'bg-purple-600' },
];
